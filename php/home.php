...
================================================== -->
	...
	<section class="recent-posts">
        ...
        <div class="row">
            <div class="col-md-8 listrecent border-right">
                <?php if (empty($content)) { $language->p('No pages found'); } ?>
                <?php foreach ($content as $page): ?>
                <!-- begin post -->
                <div class="row">
                    <div class="card col-md-12" style="margin-bottom: 30px; border: 0">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo $page->permalink(); ?>">
                                    <div style="background-image:url(<?php echo ($page->coverImage()?$page->coverImage():Theme::src('img/noimage.png')) ?>); background-size: cover; background-position: center; width:100%; height:100%;"></div>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="plugin plugin-socialnetworks">
                        <h2 class="plugin-label">Find me on social media</h2>
	...
	<div class="footer">
		...
		<p class="pull-right">
			Designed by <a target="_blank" href="https://www.paulscode.de"><span style="color: #000">pauls</span><span style="color: #b40404">code</span></a> |
